...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-[#f6f0fa] to-[#ede9fe]">
      <h2 className="text-3xl font-extrabold text-center mb-12 text-[#7c3aed] tracking-tight">Projects</h2>
      <div className="max-w-4xl mx-auto grid gap-8 md:grid-cols-2">
        {projects.map((project, index) => (
          <div key={index} className="reveal group bg-white/90 rounded-2xl shadow-lg p-8 flex flex-col border border-[#c3b1e1]">
